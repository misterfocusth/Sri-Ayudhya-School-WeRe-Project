...
export default function RecycleIceCreamWrapPage() {
    ...
    return (
        <div style={{ marginBottom: 75 }}>
            ...
            >
                การรีไซเคิลซองไอศกรีมที่เป็นกระดาษ สามารถลดการผลิตคาร์บอนไดออกไซด์ได้ <span style={{ color: "#00a152" }}>3.55</span> กิโลกรัม CO2e ต่อหนึ่งกิโลกรัม
            </Typography>
            <Typography
                variant="subtitle2"
                gutterBottom
            ...
            >
                - ควรนำเอาซองไอศกรีมไปล้างให้สะอาดเรียบร้อย ก่อนนำเอาซองมารีไซเคิล
            </Typography>
            <Typography
                variant="subtitle2"
                gutterBottom
                style={{ marginLeft: 20, marginRight: 16, marginTop: 8 }}
            >
                - ซองไอศกรีมควรอยู่ในสภาพสมบูรณ์ ไม่ชำรุดเสียหาย
            </Typography>
